...
function autocomplete(input, latInput, lngInput) {
  ...
  input.on('keydown', function (e) {
    //every key has a spesific code and Enter is 13 http://keycode.info/
...
function ajaxHeart(e) {
  ...
  console.log('hearted');
  console.log(this);
  //this is the form and has an action
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      ...
      searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result">No\n      results for ' + _this.value + ' found! </div>');
    }).catch(function (err) {
